...
export const queueCopy = {
  ...
  en: {
    ...
    numberSuffix: "",
    guidance: [
      "Before the hold countdown ends,",
      "bring your queue ticket to the Admission Line.",
      "If you miss the window, take a new queue ticket.",
    ],
    expiredGuidance: [
      "This batch has expired. Please take a new queue ticket.",
      "The current line is entering now. The next batch will be announced based on venue capacity.",
    ],

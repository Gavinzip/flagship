...
/** Temporary content copied from the previous Taiwan event page, before its recap conversion. */
export const taiwanPreview: Record<"zh-TW" | "en", KoreaEventContent> = {
  "zh-TW": {
    navigation: [
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          question: "如何購買門票？",
          answer:
            "台灣場透過 Luma 提供票價、入場權益與購票。韓國場的入場方式與預約連結尚未公布，確定後會更新於參加資訊。",
        },
        {
          category: "門票與入場",
        ...
        },
        {
          category: "現場體驗",
          question: "現場接受哪些付款方式？",
          answer: "現場所有交易皆採現金或轉帳，付款前請先向攤商確認收款資訊。",
        },
        {
          category: "門票與入場",
          question: "活動或門票可以退款嗎？",
  ...
  en: {
    ...
    event: {
      ...
      transit:
        "About a 5-minute walk from Zhongxiao Xinsheng MRT Station, Exit 1",
    },
    highlights: {
      title: "Highlights",
      english: "EVENT HIGHLIGHTS",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Taiwan admission was managed through Luma. Korea admission details and registration links will be added to the participation section when confirmed.",
        },
        {
          category: "Tickets & Entry",
